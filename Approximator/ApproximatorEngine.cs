...
public class ApproximatorEngine
{
    ...
    private double AverageError { get; set; } = double.PositiveInfinity;
    ...
    private void Approximate(ApproximatorJob job)
    {
        var thread = new Thread(() =>
        {
            ...
            this.AverageError = population.BestIndividual.Error;
            ...
            while (this.Running)
            {
                ...
                if (pbi.Error < this.AverageError)
                {
                    this.AverageError = pbi.Error;
                    this.LastImprovement = population.Id;
                }
    ...
    private void Reset()
    {
        this.AverageError = double.PositiveInfinity;
